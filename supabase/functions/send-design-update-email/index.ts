...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log(
      `Sending design update email to ${email} (requested by admin ${callerId})`
    );
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: buildEmailHtml({
          ...
          body: `
            <p style="color: #4A3728; line-height: 1.8; margin: 0 0 8px; font-size: 15px; font-family: Georgia, 'Times New Roman', serif; text-align: center;">
              Hi <strong style="color: #1C1410; font-family: Georgia, 'Times New Roman', serif;">${escapeHtml(recipientName)}</strong>,
            </p>
            <p style="color: #6B5244; line-height: 1.8; margin: 16px 0 0; font-size: 14px; font-family: Georgia, 'Times New Roman', serif; text-align: center;">
