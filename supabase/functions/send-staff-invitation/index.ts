      ...
      body: JSON.stringify({
        ...
        html: buildEmailHtml({
          ...
          body: `
            ...
            <p style="color: #5a5249; line-height: 1.8; margin: 0 0 8px; font-size: 16px; font-family: Georgia, 'Times New Roman', serif;">
              You have been invited by <strong style="color: #2C241E;">${escapeHtml(inviterName)}</strong> to join the Ce Soir staff training portal.
            </p>
            <div style="text-align: center; margin: 28px 0 8px;">
              <span style="display: inline-block; background: linear-gradient(135deg, #C06C46 0%, #D4956E 100%); color: #ffffff; font-size: 13px; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase; padding: 8px 24px; border-radius: 20px;">
                ${roleName}
              </span>
            </div>
            <p style="color: #7a7067; line-height: 1.7; margin: 20px 0 0; font-size: 15px; font-family: Georgia, 'Times New Roman', serif; text-align: center;">
          ...
          footnote: "This invitation link will expire in 7 days.",
        }),
      }),
    });
