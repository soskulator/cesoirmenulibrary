...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const inviterText = invitedByName ? ` by <strong style="color: #2C241E;">${escapeHtml(invitedByName)}</strong>` : '';
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: buildEmailHtml({
          preheader: "You've been invited to join the Ce Soir Staff Portal",
          ...
          body: `
            <p style="color: #5a5249; line-height: 1.8; margin: 0 0 8px; font-size: 16px; font-family: Georgia, 'Times New Roman', serif; text-align: center;">
              You have been invited${inviterText} to join the Ce Soir staff training portal.
            </p>
