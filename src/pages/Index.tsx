...
// ─── Animation variants (reduced set — no AnimatePresence needed) ───
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Master the menu, create positive memories.
            </p>
          </motion.div>
        ...
        <section className="py-14 md:py-24 bg-muted/30">
          <div className="container">
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="font-serif text-3xl font-semibold text-center mb-2">
                Featured Cocktail
              </h2>
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Daily rotating dishes to study
              </p>
            </div>
            <Button
              variant="ghost"
              className="text-copper hover:text-copper-light self-start sm:self-center"
              asChild
            >
              <Link to="/daily-focus">
                View all
        ...
        <div className="container">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Showing 3 of {categories.length} categories
              </p>
            </div>
            <Button
              variant="ghost"
          ...
          >
            {categories.slice(0, 3).map((category) => {
              const itemCount = menuItems.filter(
                (i) => i.categoryId === category.id && i.isPublished
              ).length;
            ...
            <Card className="border-0 bg-gradient-to-r from-charcoal to-charcoal-light text-cream overflow-hidden">
              <CardContent className="p-8 md:p-12">
                <div className="grid gap-8 grid-cols-2 md:grid-cols-4 text-center">
                  <div>
                    <p className="text-4xl md:text-5xl font-serif font-bold text-copper">
                      {menuItems.length}
                    </p>
                    <p className="text-sm text-cream/60 mt-2 tracking-wide uppercase">
                      Menu Items
                    </p>
                  </div>
                  <div>
