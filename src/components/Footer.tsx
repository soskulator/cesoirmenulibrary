        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-cream/60 text-sm leading-relaxed">
              French-inspired cuisine in the heart of Naples, Florida. 
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/70">
              <li className="flex items-start gap-3">
                ...
                <span>463 Bayfront Place<br />Naples, FL 34102</span>
              </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-cream/10 flex items-center justify-center text-cream/70 hover:bg-copper hover:text-charcoal transition-all"
