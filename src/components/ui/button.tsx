  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        copper: "bg-copper text-white hover:bg-copper-light shadow-sm hover:shadow-md dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/90",
        "copper-outline": "border-2 border-copper text-copper bg-white hover:bg-copper hover:text-white dark:border-primary dark:text-primary dark:bg-transparent dark:hover:bg-primary dark:hover:text-primary-foreground",
