...
export function Header() {
  ...
  return <>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/85 pt-[env(safe-area-inset-top)]">
